<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_DanhSachHocSinhAnSang_Block.aspx.cs" Inherits="admin_page_module_function_module_DiemDanh_module_DanhSachHocSinhAnSang_Block" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
            ...
            <div class="col-sm-10">
                <asp:UpdatePanel ID="udButton" runat="server">
                    <ContentTemplate>
                        ...
                        <input type="submit" class="btn btn-primary" value="Gỡ lock" onclick="confirmDel()" />
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="700" Height="600" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
        ...
        HeaderText="Danh sách chi tiết" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" AutoUpdatePosition="true" ClientSideEvents-CloseUp="function(s,e){grvList.Refresh();}">
        <ContentCollection>
                                            ...
                                            <asp:Repeater ID="rpList" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%#Eval("ansang_datecreate") %></td>
                                                        <td><%#Eval("ansang_dateend") %></td>
                                                       <%-- <td><%#Eval("ansang_dot") %></td>--%>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </tbody>
