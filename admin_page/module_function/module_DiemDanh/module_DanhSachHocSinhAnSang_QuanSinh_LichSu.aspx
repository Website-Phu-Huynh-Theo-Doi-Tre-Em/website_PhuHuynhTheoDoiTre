<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_DanhSachHocSinhAnSang_QuanSinh_LichSu.aspx.cs" Inherits="admin_page_module_function_module_DiemDanh_module_DanhSachHocSinhAnSang_QuanSinh_LichSu" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="hstl_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Ăn sáng" FieldName="diemdanh_ansang" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Ngày" FieldName="diemdanh_ngay" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                </Columns>
