...
public partial class admin_page_module_function_module_VietNhatKids_module_NhanXetSucKhoeHangNgay : System.Web.UI.Page
{
            ...
            if (checkDiemDanh.Count() > 0)
            {
                ...
                var listHocSinh = (from hs in db.tbHocSinhs
                                   ...
                                   select new
                                   {
                                       ...
                                       hs.hocsinh_id,
                                       hstl.hstl_id,
                                       tamtrang = db.tbVietNhatKids_NhanXetThuongXuyens.Any(x => x.nhanxetthuongxuyen_datecreate.Value.Day == DateTime.Now.Day
                                                  ...
                                                  && x.nhanxetthuongxuyen_cate == "suckhoe" && x.hstl_id == hstl.hstl_id) ?
                                                   (from nx in db.tbVietNhatKids_NhanXetThuongXuyens
                                                    ...
                                                    && nx.nhanxetthuongxuyen_cate == "suckhoe" && nx.hstl_id == hstl.hstl_id
                                                    orderby nx.nhanxetthuongxuyen_id descending
                                                    select nx).First().nhanxetthuongxuyen_content : "---",
                                       ghichu = db.tbVietNhatKids_NhanXetThuongXuyens.Any(x => x.nhanxetthuongxuyen_datecreate.Value.Day == DateTime.Now.Day
                                                     && x.nhanxetthuongxuyen_datecreate.Value.Month == DateTime.Now.Month
                                                     && x.nhanxetthuongxuyen_datecreate.Value.Year == DateTime.Now.Year
                                                     && x.nhanxetthuongxuyen_cate == "suckhoe" && x.hstl_id == hstl.hstl_id) ?
                                                   (from nx in db.tbVietNhatKids_NhanXetThuongXuyens
                                                    ...
                                                    && nx.nhanxetthuongxuyen_cate == "suckhoe" && nx.hstl_id == hstl.hstl_id
                                                    orderby nx.nhanxetthuongxuyen_id descending
                                                    select nx).First().nhanxetthuongxuyen_ghichu : "",
                ...
                if (db.tbVietNhatKids_NhanXetThuongXuyens.Any(x => x.nhanxetthuongxuyen_datecreate.Value.Day == DateTime.Now.Day
                                   && x.nhanxetthuongxuyen_datecreate.Value.Month == DateTime.Now.Month
                                   && x.nhanxetthuongxuyen_datecreate.Value.Year == DateTime.Now.Year
                                   && x.nhanxetthuongxuyen_cate == "suckhoe"
                                   && x.lop_id == getLop.lop_id && x.namhoc_id == checkNamHoc.namhoc_id))
                {
                    var checkNhanXet = (from nx in db.tbVietNhatKids_NhanXetThuongXuyens
                                        ...
                                        && nx.nhanxetthuongxuyen_datecreate.Value.Month == DateTime.Now.Month
                                        && nx.nhanxetthuongxuyen_datecreate.Value.Year == DateTime.Now.Year
                                        && nx.nhanxetthuongxuyen_cate == "suckhoe"
        ...
        var checkLichSu = from ls in db.tbLichSus
                          ...
                          && ls.lichsu_date.Value.Day == DateTime.Now.Day
                           && ls.lichsu_date.Value.Month == DateTime.Now.Month
                             ...
                             && ls.danhsachcongviec_id == 2
                          select ls;

        if (txtContentTong.Value.Replace("-", "") == "")
        {
            alert.alert_Warning(Page, "Vui lòng chọn nội dung nhận xét!", "");
        }
        else
        {
            db.Connection.Open();
            using (var transaction = db.Connection.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        insertls.danhsachcongviec_id = 2;
                    ...
                    for (int i = 0; i < arrHocSinh.Length; i++)
                    {
                        ...
                        var checkNhanXet = (from nx in db.tbVietNhatKids_NhanXetThuongXuyens
                                            ...
                                            && nx.nhanxetthuongxuyen_datecreate.Value.Month == DateTime.Now.Month
                                            && nx.nhanxetthuongxuyen_datecreate.Value.Year == DateTime.Now.Year
                                            && nx.nhanxetthuongxuyen_cate == "suckhoe" && nx.hstl_id == Convert.ToInt32(arrHocSinh[i])
                                            orderby nx.nhanxetthuongxuyen_id descending
                                            select nx);
                        if (checkNhanXet.Count() > 0)
                        {
                            ...
                            checkNhanXet.First().nhanxetthuongxuyen_ghichu = arrListGhiChu[i].ToString();
                        ...
                        else
                        {
                            ...
                            insert.nhanxetthuongxuyen_cate = "suckhoe";
                            insert.nhanxetthuongxuyen_datecreate = DateTime.Now;
                            insert.nhanxetthuongxuyen_content = arrListStr[i].ToString();
                            if (arrListGhiChu.Length == arrHocSinh.Length)
                                insert.nhanxetthuongxuyen_ghichu = arrListGhiChu[i].ToString();
