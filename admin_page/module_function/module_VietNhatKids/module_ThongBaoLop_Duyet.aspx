<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThongBaoLop_Duyet.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_ThongBaoLop_Duyet" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="thongbaoLop_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Ngày đăng" FieldName="thongbaolop_datecreate" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Lớp" FieldName="lop_name" HeaderStyle-HorizontalAlign="Center" Width="8%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Trạng thái" FieldName="trangthai" HeaderStyle-HorizontalAlign="Center" Width="8%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                </Columns>
