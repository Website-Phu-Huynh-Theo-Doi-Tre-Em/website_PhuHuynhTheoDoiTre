<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThongBaoTruong.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_ThongBaoTruong" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <script type="text/javascript">
        ...
        function checkNULL() {
            var khoi = document.getElementById('<%= txtKhoi_ID.ClientID%>');
            ...
            if (khoi.value.trim() == "") {
                swal('Vui lòng chọn khối!', '', 'warning');
                return false;
            }
            return true;
        }
        ...
        window.onload = function () {
            let idKhoi = document.getElementById("<%=txtKhoi_ID.ClientID%>").value;
            $("#ck01" + idKhoi).prop('checked', true);
        };
    </script>
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="thongbaotruong_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tiêu đề" FieldName="thongbaotruong_title" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <%--<dx:GridViewDataColumn Caption="Người nhập" FieldName="username_fullname" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>--%>
                    <dx:GridViewDataColumn Caption="Ngày đăng" FieldName="thongbaotruong_datecreate" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                </Columns>
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="1200px" Height="600px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
        ...
        HeaderText="Thông báo trường" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" AutoUpdatePosition="true" ClientSideEvents-CloseUp="function(s,e){grvList.Refresh();}">
        <ContentCollection>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 form-group" id="div_Khoi" runat="server">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <%--<dx:ASPxComboBox ID="ddlloaitrang" runat="server" ValueType="System.Int32" TextField="khoi_name" ValueField="khoi_id" ClientInstanceName="ddlloaisanpham" CssClass="" Width="90%"></dx:ASPxComboBox>--%>
                                            </div>
                                        </div>
