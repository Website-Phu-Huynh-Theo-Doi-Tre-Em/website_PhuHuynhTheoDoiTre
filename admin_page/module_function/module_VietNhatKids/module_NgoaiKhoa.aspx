<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_NgoaiKhoa.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_NgoaiKhoa" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="ngoaikhoa_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tiêu đề" FieldName="ngoaikhoa_name" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Mô tả" FieldName="ngoaikhoa_description" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                </Columns>
