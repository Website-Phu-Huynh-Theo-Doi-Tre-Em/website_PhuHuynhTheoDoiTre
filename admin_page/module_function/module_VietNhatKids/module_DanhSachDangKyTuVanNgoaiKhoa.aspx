<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_DanhSachDangKyTuVanNgoaiKhoa.aspx.cs" Inherits="admin_page_module_function_module_VietNhatKids_module_DanhSachDangKyTuVanNgoaiKhoa" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        <h3 style="text-align: center; font-size: 28px; font-weight: bold; color: blue">DANH SÁCH ĐĂNG KÝ TƯ VẤN NGOẠI KHÓA</h3>
        <div class="form-group row">
            <div class="col-sm-10">
                <asp:UpdatePanel ID="udButton" runat="server" Visible="true">
                    <ContentTemplate>
                ...
                <a href="#" class="btn btn-primary" id="btnXuatExcel" runat="server" onserverclick="btnXuatExcel_ServerClick" visible="false">Xuất excel</a>
            </div>
        </div>
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="tuvan_ngoaikhoa_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Chương trình đăng ký" FieldName="ngoaikhoa_name" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Ngày đăng ký" FieldName="tuvan_ngoaikhoa_createdate" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
