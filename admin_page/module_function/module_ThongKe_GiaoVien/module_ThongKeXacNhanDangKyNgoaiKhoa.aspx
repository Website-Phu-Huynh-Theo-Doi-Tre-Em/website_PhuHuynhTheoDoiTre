<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThongKeXacNhanDangKyNgoaiKhoa.aspx.cs" Inherits="admin_page_module_function_module_ThongKe_GiaoVien_module_ThongKeXacNhanDangKyNgoaiKhoa" %>
        ...
        <ContentTemplate>
            <div class="main-omt">
                <div class="omt-header">
                    ...
                    <h4 class="header-title">Thống kê xác nhận ngoại khóa</h4>
                </div>
            </div>
            <div class="card card-block">
                <%-- <div class="form-group row" style="display: flex; align-items: center;">
                    <asp:DropDownList ID="ddlNamHoc" CssClass="form-control" runat="server" OnSelectedIndexChanged="ddlNamHoc_SelectedIndexChanged" Width="20%" AutoPostBack="true"></asp:DropDownList>
                    <asp:DropDownList ID="ddlCoSo" CssClass="form-control ml-1" runat="server" OnSelectedIndexChanged="ddlCoSo_SelectedIndexChanged" Width="24%" AutoPostBack="true"></asp:DropDownList>
                </div>--%>
                ...
                <div class="form-group table-responsive">
                    <div class="tab-content">
                        <table class="table table-bordered">
                            <thead class="thead-omt">
                                <tr>
                                    ...
                                    <th scope="col">Tổng xác nhận ngoại khóa</th>
                                    <th scope="col">Tổng điểm tích lũy</th>
                                    <th scope="col">#</th>
                                </tr>
                            </thead>
                            <tbody>
                                <asp:Repeater runat="server" ID="rpThongKeXacNhanNgoaiKhoa">
                                    <ItemTemplate>
                                        <tr>
                                            <th scope="row"><%#Container.ItemIndex+1 %></th>
                                            <td><%#Eval("username_fullname") %></td>
                                            <td><%#Eval("tongXacNhan") %></td>
                                            <td><%#Eval("tongDiem") %></td>
                                            <td>
                        ...
                        <asp:Repeater ID="rpGiaoVienXacNhanNgoaiKhoa" runat="server" OnItemDataBound="rpGiaoVienXacNhanNgoaiKhoa_ItemDataBound">
                            <ItemTemplate>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <asp:Repeater ID="rpChiTietXacNhanNgoaiKhoa" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <th><%#Container.ItemIndex+1 %></th>
                                                                    <td><%#Eval("dangkyngoaikhoa_datecreate", "{0: dd/MM/yyyy}") %></td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                    </tbody>
