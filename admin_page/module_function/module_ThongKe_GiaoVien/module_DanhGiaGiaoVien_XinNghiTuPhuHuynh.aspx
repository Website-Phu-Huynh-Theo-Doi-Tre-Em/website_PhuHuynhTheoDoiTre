<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_DanhGiaGiaoVien_XinNghiTuPhuHuynh.aspx.cs" Inherits="admin_page_module_function_module_VietNhatKids_module_DanhGiaGiaoVien_XinNghiTuPhuHuynh" %>
            ...
            <div class="card card-block">
                ...
                <div class="form-group table-responsive">
                    <div class="tab-content">
                        <div ></div>
                            <h3><%=title_name %></h3>
                        <span>Lưu ý: Điểm tích lũy sẽ tính khi giáo viên xác nhận xin nghỉ từ phụ huynh</span>
