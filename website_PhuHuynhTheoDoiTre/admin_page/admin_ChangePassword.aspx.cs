...
public partial class website_PhuHuynhTheoDoiTre_admin_page_admin_ChangePassword : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("/website_PhuHuynhTheoDoiTre/admin_page/adminl_Login.aspx");
        }
    }
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        else if (getuser.username_password == passmd5)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "AlertBox", "swal('Mật khẩu đã được thay đổi!', 'Vui lòng đăng nhập lại hệ thống','success').then(function(){window.location = '/website_PhuHuynhTheoDoiTre/admin_page/adminl_Login.aspx';})", true);
            }
        }
    }
}