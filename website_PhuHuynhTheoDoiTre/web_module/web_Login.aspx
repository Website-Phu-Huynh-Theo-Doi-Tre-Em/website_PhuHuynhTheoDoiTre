<%@ Page Language="C#" AutoEventWireup="true" CodeFile="web_Login.aspx.cs" Inherits="web_module_website_VietNhatKids_web_Login" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="card card-container">
                <img id="profile-img" class="profile-img-card" src="/admin_images/logo_mamnon.png" />
                ...
                <!-- /form -->
                <a href="/website_PhuHuynhTheoDoiTre/web_module/web_QuenMatKhau.aspx" class="forgot-password">Quên mật khẩu?
                </a>
            </div>
