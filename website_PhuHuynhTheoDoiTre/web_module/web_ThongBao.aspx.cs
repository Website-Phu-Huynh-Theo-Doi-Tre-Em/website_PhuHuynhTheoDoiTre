...
public partial class website_PhuHuynhTheoDoiTre_web_module_web_ThongBao : System.Web.UI.Page
{
    public int STT = 1;
    public int STTT = 1;
    ...
    {
        if (Request.Cookies["PhuHuynhHocSinh"] != null)
        {
            ...
            var getThongBaoLop = from hs in db.tbHocSinhs
                                 ...
                                 where tb.loaithongbao_ID == 2 && tb.namhoc_id == namhoc_id && hs.hocsinh_taikhoan == Request.Cookies["PhuHuynhHocSinh"].Value
                                 select new
                                 {
                                     tb.thongbao_title,
                                     tb.thongbao_id,
        ...
        {
            Response.Redirect("/website_PhuHuynhTheoDoiTre/web_module/web_Login.aspx");
        }
