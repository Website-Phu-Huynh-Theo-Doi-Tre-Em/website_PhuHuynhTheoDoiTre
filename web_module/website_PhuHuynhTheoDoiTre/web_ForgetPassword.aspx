<%@ Page Language="C#" AutoEventWireup="true" CodeFile="web_ForgetPassword.aspx.cs" Inherits="web_module_website_VietNhatKids_web_ForgetPassword" %>
...
<body>
    ...
    <form id="msform" runat="server">
        ...
        <fieldset class="step1">
            ...
            <h3 class="fs-subtitle">Nhập Gmail để nhận mã OPT!</h3>
            <input type="text" name="email" placeholder="Email" runat="server" id="txtEmail" />


            <a  id="btnGui" onclick="return checkNull()" onserverclick="btnSendEmail_ServerClick"  runat="server" name="next" class="next action-button" style="width: 96%!important; border-radius: 5px!important;">Gửi</a>
           


        </fieldset>
        <fieldset >
            <h4 class="fs-title">Mã xác nhận đã gửi về mail vui lòng kiểm tra và điền mã xác nhận!</h4>
            <%--<h3 class="fs-subtitle">Your presence on the social network</h3>--%>
            <input type="text" id="txtMaOTP" name="twitter" placeholder="nhập mã otp" />
